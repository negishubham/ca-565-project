...
# ./runall.pl -f $num_parallel_jobs -d "../results/GSHARE.32KB" -dbg
...
./runall.pl -f $num_parallel_jobs -d "../results/GSHARE.04KB" -dbg
./runall.pl -f $num_parallel_jobs -d "../results/GSHARE.08KB" -dbg
./runall.pl -f $num_parallel_jobs -d "../results/GSHARE.16KB" -dbg
